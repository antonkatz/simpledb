...
export declare class Table<V> {
    ...
    overwrite: (key: string, value: V) => Promise<string | undefined>;
    patch: (key: string, patch: Patch[], onExistingOnly?: boolean) => Promise<string | undefined>;
    private patchTransient;
